...
class RagnarokResearchScraper(BaseScraper):
    def __init__(self):
        super().__init__(
            url="https://researchragnarok.substack.com/archive"
        )
        self.name = 'Research Ragnarok'
        self.base_url = "https://researchragnarok.substack.com"
        ...
        try:
            ...
            for post in post_elements:
                try:
                    ...
                    # Try to extract ticker and company name from title
                    company_name = ""
                    ticker = ""
                    
                    # # Look for ticker in format $TICK or (TICK)
...
if __name__ == "__main__":
    scraper = ResearchRagnarokScraper()
    reports = scraper.scrape()
    print("\nResearch Ragnarok Reports:")
